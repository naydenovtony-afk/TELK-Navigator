        ...
        <div className="space-y-4 animate-pulse">
          <div className="bg-medical-surface rounded-2xl border border-medical-border p-6">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-3 h-3 rounded-full bg-medical-border/50 shrink-0" />
              <div className="h-4 w-36 bg-medical-border/40 rounded" />
            </div>
          ...
          <div className="bg-white rounded-2xl border border-medical-border p-4 sm:p-6">
            <div className="h-3 w-36 bg-medical-border/40 rounded mb-5" />
            <div className="space-y-4">
              {[0, 1, 2, 3].map((i) => (
                <div key={i} className="flex gap-3">
                  <div className="w-4 h-4 bg-medical-border/40 rounded mt-0.5 shrink-0" />
                  <div className="flex-1 space-y-1.5">
                    <div className="h-3 bg-medical-border/40 rounded w-3/4" />
                    <div className="h-3 bg-medical-border/40 rounded w-full" />
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white rounded-2xl border border-medical-border p-4 sm:p-6">
            <div className="h-3 w-28 bg-medical-border/40 rounded mb-4" />
            <div className="space-y-2">
              <div className="h-3 bg-medical-border/40 rounded w-full" />
              <div className="h-3 bg-medical-border/40 rounded w-5/6" />
              <div className="h-3 bg-medical-border/40 rounded w-full" />
            </div>
          </div>
        </div>
